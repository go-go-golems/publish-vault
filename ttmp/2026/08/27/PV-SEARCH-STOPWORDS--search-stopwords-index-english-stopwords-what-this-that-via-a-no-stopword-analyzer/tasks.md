...
- [x] P3. Build via CI (publish-image), merge GitOps PRs for retro-obsidian-publish + obsidian-vault-publish (sha-<new>).
- [x] P4. Verify live on parc.yolo.scapegoat.dev that "what"/"this"/"that" return results; confirm index rebuilt.
