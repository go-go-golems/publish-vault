...
- [x] Phase 4: refuse to store the empty slug (non-Latin filenames slugify to "") and replace last-write-wins slug collisions with a deterministic disambiguating suffix; re-run scripts/05-vault-slug-audit until the collision section is empty <!-- t:875m -->
