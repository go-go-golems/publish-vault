...
- [ ] FOLLOW-UP (separate bug, not fixed here): [[#Heading]] same-note links render as <a href="/note/#heading" ...></a> — empty display text, points at the vault root. Six occurrences in the Pattern Zoo ToC. <!-- t:z5hp -->
